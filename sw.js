const CACHE='r971-staff-v22';
const ASSETS=['./','./index.html','./styles.css','./app.js','./performance-fix.js','./debt-fix.js','./admin.js','./live-shift.js','./attendance.js','./quick-revenue.js','./attendance-delete-mode.js','./manifest.webmanifest','./icon.svg'];
